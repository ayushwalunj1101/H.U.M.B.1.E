"""
Unified Backend — Singleton Client Pool
Initialize Groq + MongoDB clients ONCE at server startup.
Lifted from backend2/app/services/singletons.py
"""
import logging
from motor.motor_asyncio import AsyncIOMotorClient
from groq import AsyncGroq
from config import DEEPGRAM_API_KEY, GROQ_API_KEY, MONGODB_URI
