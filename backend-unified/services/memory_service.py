"""
Unified Backend — Memory Service
MongoDB CRUD + Atlas Vector Search for semantic memory retrieval.
Lifted from backend2/app/services/memory_service.py
"""
import time
import logging
from services.singletons import get_db
from services.embedding_service import get_embedding
from config import VECTOR_SEARCH_INDEX, MEMORY_RELEVANCE_THRESHOLD
